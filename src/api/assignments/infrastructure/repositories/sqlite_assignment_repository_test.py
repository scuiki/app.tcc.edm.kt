...
def classroom_id(tmp_db) -> int:
    # SQL direto porque o repositório da turma é infraestrutura de outra funcionalidade
    return tmp_db.execute("INSERT INTO classroom (name, created_at) VALUES ('T', 't0');").lastrowid
