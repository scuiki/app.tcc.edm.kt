...
class IStagedCleanedSubmissions(Protocol):
    def publish(self) -> None: ...

    def discard(self) -> None: ...


class ICleanedSubmissionsStore(Protocol):
    def stage(self, classroom_slug: ClassroomSlug, cleaned: pd.DataFrame) -> IStagedCleanedSubmissions: ...
