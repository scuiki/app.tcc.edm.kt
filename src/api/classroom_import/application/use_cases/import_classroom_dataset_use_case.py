...
class ImportClassroomDatasetUseCase(WriteUseCase):
    ...
    def execute(self, dto: ImportClassroomDatasetDTO) -> ImportClassroomDatasetResponseDTO:
        # A turma já existe, criada pelo professor; um segundo envio cria assignments novos
    ...
    def _import(self, dto: ImportClassroomDatasetDTO) -> ClassroomImportReport:
        ...
        self._save(dto.classroom_id, cleaned, per_assignment)
    ...
    def _save(
        ...
        # Os assignments, os problemas e o dado limpo de cada um, tudo ou nada.
