"""A rede do Code-DKT (Shi et al., EDM 2022): LSTM com atenção code2vec sobre os AST paths.

Portado do TCC 1 (src/models/code_dkt.py). Numérica congelada. O treino está em training.py e a
predição em prediction.py; aqui fica só a rede.
"""
