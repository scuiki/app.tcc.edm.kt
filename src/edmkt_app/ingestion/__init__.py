...
`edmkt_app.persistence` (portas da Fase 2) e do contrato de colunas do `ml`; o núcleo
científico (ml) é framework-free e NUNCA importa daqui. Este pacote é dono do stream
