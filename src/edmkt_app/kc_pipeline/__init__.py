...
roda o pipeline puro (`ml.kc_generation`) pelo transporte `claude` com cache, valida o conteúdo
...
a coordenação é só pela linha `pipeline_lock` + WAL. `ml.kc_generation` é só ORQUESTRADO — o
