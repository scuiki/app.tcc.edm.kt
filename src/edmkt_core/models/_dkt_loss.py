# Ported from tcc.edm.kt @ 0e8807c — src/models/dkt.py (dkt_loss only, :138-176)
# DKT loss — Piech et al. (2015), Eq. 3. Numerics frozen; characterization tests gate any refactor.
